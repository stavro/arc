defmodule Mix.Tasks.Arc.Gen.Uploader do
  use Mix.Task
  import Mix.Generator
  import Mix.Utils, only: [camelize: 1, underscore: 1]

  @shortdoc "Generate an Arc uploader"
  ...
  def run(_) do
    IO.puts "Incorrect syntax. Please try mix arc.gen.uploader <model_name>"
  end
  ...
  defmodule <%= inspect @uploader_model_name %> do
    # For use with Ecto, remove `use Arc` in favor of `use Arc.Ecto`.
